  ...
  return (
    <article className="max-w-3xl space-y-6 text-ink">
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">1. Data calc_OS does not collect</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">2. What happens in your browser</h2>
        <ul className="list-disc list-inside space-y-1">
          ...
          <li><b>Storage.</b> calc_OS keeps exactly one value in your browser's localStorage: the light or dark appearance you pick in the header. It sets no cookies and stores nothing else, apart from the service worker described in the next point.</li>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">3. Hosting</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">4. Links to other sites</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">5. Children</h2>
        <p>calc_OS collects no personal information from anyone, including children under 13.</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-semibold text-ink">6. Changes and contact</h2>
