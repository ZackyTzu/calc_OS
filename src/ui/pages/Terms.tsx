  ...
  return (
    <article className="max-w-3xl space-y-6 text-ink">
      <header className="space-y-1">
        <h1 className="text-4xl font-semibold text-ink">Terms and conditions</h1>
        <p className="text-sm text-faint">Last updated 6 September 2026</p>
      </header>

      <section className="space-y-2">
        <h2 className="font-semibold text-ink">1. Who runs calc_OS</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">2. Agreement</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">3. What the site does</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">4. Your responsibilities</h2>
        <ul className="list-disc list-inside space-y-1">
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">5. No warranty and limitation of liability</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">6. Third-party programs and links</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-ink">9. Contact</h2>
