  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <Card className="space-y-2 text-slate-300">
        ...
        <p>Source code: <a className="text-emerald-300 underline" href="https://github.com/ZackyTzu/calc_OS" target="_blank" rel="noreferrer">github.com/ZackyTzu/calc_OS</a> (GPL-3.0-or-later).</p>
      </Card>
      ...
      <Card className="space-y-2 text-slate-300">
        ...
        <ul className="list-disc list-inside text-sm space-y-1">
          <li>USB protocol knowledge from <a className="underline" href="https://github.com/debrouxl/tilibs">tilibs</a> (Lionel Debroux, Romain Liévin and contributors), Benjamin Moody's protocol analysis, and Adrien Bertrand's WebTILP.</li>
          <li>TI-BASIC token data from the <a className="underline" href="https://github.com/TI-Toolkit/tokens">TI-Toolkit token sheets</a>; generated files are cross-checked with <a className="underline" href="https://github.com/TI-Toolkit/tivars_lib_py">tivars_lib_py</a>.</li>
