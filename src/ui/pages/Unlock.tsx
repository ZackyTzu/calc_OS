...
export function Unlock() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <h1 className="text-xl font-semibold">Unlock assembly games on the TI-84 Plus CE</h1>
      ...
      <Card className="space-y-2">
        ...
        <p className="text-xs text-muted">Turn off automatic updates in TI Connect CE and decline OS update prompts to keep a working setup.</p>
      </Card>
      <Card className="space-y-2">
        ...
        <p className="text-xs text-muted">arTIfiCE publishes no redistribution licence, so calc_OS links to the official download instead of hosting a copy.</p>
      </Card>
      <Card className="space-y-2">
