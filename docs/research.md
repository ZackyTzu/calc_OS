...
### DUSB protocol (TI-84 Plus CE) — for a from-scratch TS implementation
...
- ASM/C programs need: (a) OS <= 5.4, or (b) arTIfiCE jailbreak. Timeline: 5.5 (2020) removed ASM; arTIfiCE v1 5.3–5.8.2; TI 5.8.3 (May 2025) patched; arTIfiCE v2 (Aug 2025) works 5.3–5.8.4; **TI OS 5.8.5 (Apr 17 2026) blocks arTIfiCE v2, no v3 exists, cannot downgrade without a pre-installed ASM shell.** Sources: cemetech.net t=21109, yvantt.github.io/arTIfiCE.
